...
class UserPreferencesFormTests(TestCase):
    ...
    def test_form_persists_preferences(self) -> None:
        ...
        self.assertEqual(preferences.theme_primary_color, '#123abc')
        self.assertEqual(preferences.theme_secondary_color, '#abcdef')

    def test_form_rejects_invalid_colors(self) -> None:
        data = {
            'nickname': 'Ace',
            'favorite_team_id': '',
            'favorite_player_id': '',
            'theme_primary_color': '123abc',
            'theme_secondary_color': '#zzz123',
        }
