...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(blank=True, help_text='Generic option that won this event', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='winning_event_outcomes', to='predictions.option'),
        ),
        migrations.AddField(
            model_name='predictionoption',
            name='option',
            field=models.ForeignKey(blank=True, help_text='Generic option reference for any type of prediction target', null=True, on_delete=django.db.models.deletion.CASCADE, related_name='prediction_options', to='predictions.option'),
        ),
        migrations.AddField(
            model_name='usertip',
            name='selected_option',
            field=models.ForeignKey(blank=True, help_text='Generic option selected for any type of prediction', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='tips', to='predictions.option'),
        ),
        migrations.AddField(
            model_name='option',
            name='category',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='options', to='predictions.optioncategory'),
        ),
        migrations.AddIndex(
            model_name='option',
